...
//  Copyright (c) 2016年 Cube. All rights reserved.
//
 ...
 */
#define kNotifyURL @"https://app.test.com/payment/verify"


/**
 *  appSckeme:应用注册scheme,在Info.plist定义URLtypes，处理支付宝回调
 */
#define kAppScheme @"com.even.ECPay"
 ...
 *  支付接口名称
 */
#define kPayService @"mobile.securitypay.pay"
